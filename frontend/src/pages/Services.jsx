    ...
    <div data-testid="services-page">
      ...
      <section className="py-24">
        ...
        <div className="rounded-3xl dark-card text-white p-10 md:p-16 relative overflow-hidden">
          ...
          <a href={`mailto:${PROFILE.email}`} data-testid="services-cta" className="relative mt-8 inline-flex items-center gap-2 px-7 py-4 rounded-full bg-white text-[#C71E73] font-semibold text-sm hover:bg-[#C71E73] hover:text-white transition-colors">

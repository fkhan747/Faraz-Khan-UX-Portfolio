  ...
  return (
    <nav aria-label="Project navigation" className="flex items-center gap-2 sm:gap-2.5">
      <Link to={prev.href} data-testid="prev-project" title={`Previous project: ${prev.title}`}
        className="pnav-chip group flex items-center gap-2 rounded-xl border border-white/12 bg-white/[0.04] px-3 py-1.5 hover:bg-white/10 hover:border-white/25 transition-colors">

...
export default function OwnedCard({ items = [], accent = "#F5379B", className = "" }) {
  ...
  return (
    <Reveal className={`mt-7 max-w-4xl rounded-2xl p-5 bg-[#100210]/55 backdrop-blur-md border border-white/12 ${className}`}>
      <p className="text-[10px] font-mono uppercase tracking-widest mb-3" style={{ color: accent }}>What I owned</p>

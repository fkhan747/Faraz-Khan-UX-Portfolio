 ...
 * Renders through VaultImage so encrypted case-study screens decrypt in
 * place; plain paths pass through untouched.
 */
  ...
  return (
    ...
    >
      <div className="overflow-hidden rounded-[1.25rem] bg-white">
        <VaultImage src={src} alt={alt} loading="lazy" className="block w-full h-auto" />
      </div>
    </div>
  );
}
